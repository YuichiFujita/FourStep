...
namespace keyboard
{
	const int MAX_NUMKEY = 256;	// キーの最大数
}
...
private:
	// メンバ変数
	BYTE m_aKeyStatePress[keyboard::MAX_NUMKEY];	// プレス情報
	BYTE m_aKeyStateTrigger[keyboard::MAX_NUMKEY];	// トリガー情報
	BYTE m_aKeyStateRelease[keyboard::MAX_NUMKEY];	// リリース情報
};
