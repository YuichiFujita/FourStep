...
//	静的メンバ変数宣言
//************************************************************
CObject *CObject::m_apTop[object::MAX_PRIO] = {};	// 先頭のオブジェクトへのポインタ
CObject *CObject::m_apCur[object::MAX_PRIO] = {};	// 最後尾のオブジェクトへのポインタ
...
//	コンストラクタ
//============================================================
CObject::CObject() : CObject(LABEL_NONE, object::DEFAULT_PRIO) // 委譲コンストラクタ
{
